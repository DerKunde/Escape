...
public class RotateUp : MonoBehaviour
{
    ...
    void Update()
    {
        if (activated)
        {
            ...
            //linearer Farbwechsel, wurde durch "Laser" ersetzt
